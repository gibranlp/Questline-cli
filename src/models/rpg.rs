...
impl Achievement {
    pub fn static_list() -> Vec<(&'static str, &'static str, &'static str)> {
        vec![
            ...
            (
                "high_priority_slayer",
                "High Priority Slayer",
                "Complete 25 high-priority quests.",
            ),
            ("step_sweeper", "Step Sweeper", "Complete 50 quest steps."),
            (
                "recurring_keeper",
                "Recurring Keeper",
                "Complete 25 recurring quests.",
            ),
            (
                "deadline_dodger",
                "Deadline Dodger",
                "Complete 50 quests with due dates.",
            ),
            ...
            (
                "tree_sprout",
                "Tree Sprout",
                "Grow The Evergrowth to Stage 2.",
            ),
            (
                "tree_guardian",
                "Tree Guardian",
                "Grow The Evergrowth to Stage 3.",
            ),
            (
                "tree_elder",
                "Tree Elder",
                "Grow The Evergrowth to Stage 4.",
            ),
            (
                "tree_ascendant",
                "Tree Ascendant",
                "Reach 500 total tree growth.",
            ),
            (
                "hyd_first_glass",
                "First Glass",
            ...
            (
                "hyd_daily_goal",
                "Hydration Pact",
                "Reach your daily hydration target once.",
            ),
            (
                "hyd_week_goals",
                "Seven Clear Springs",
                "Reach your hydration target on 7 days.",
            ),
            (
                "hyd_fortnight_goals",
                "Fourteen Clear Springs",
                "Reach your hydration target on 14 days.",
            ),
            (
                "hyd_month_goals",
                "Wellkeeper",
                "Reach your hydration target on 30 days.",
            ),
            (
                "hyd_100_glasses",
                "River Initiate",
                "Log 100 glasses of water.",
            ),
            (
                "hyd_500_glasses",
                "River Guardian",
                "Log 500 glasses of water.",
            ),
            (
                "hyd_1000_glasses",
                "Living River",
                "Log 1,000 glasses of water.",
            ),
            (
                "hyd_overachiever",
                "Overflowing Flask",
                "Log 12 glasses in a single day.",
            ),
            (
                "hundred_day_journey",
                "Hundred Day Journey",
            ...
            (
                "focus_grandmaster",
                "Focus Grandmaster",
                "Complete 1,000 focus sessions.",
            ),
            (
                "focus_hour",
                "One Hour Ward",
                "Complete a 60-minute focus session.",
            ),
            (
                "ninety_minute_sage",
                "90 Minute Sage",
            ...
            (
                "two_hour_anchor",
                "Two Hour Anchor",
                "Complete a 120-minute focus session.",
            ),
            (
                "silent_monk",
                "Silent Monk",
            ...
            (
                "silent_adept",
                "Silent Adept",
                "Complete 50 focus sessions in silence.",
            ),
            (
                "forest_wanderer",
                "Forest Wanderer",
            ...
            (
                "forest_warden",
                "Forest Warden",
                "Complete 100 focus sessions with Forest Sounds.",
            ),
            (
                "rain_listener",
                "Rain Listener",
            ...
            (
                "storm_listener",
                "Storm Listener",
                "Complete 100 focus sessions with Rain Sounds.",
            ),
            (
                "master_atmosphere",
            ...
            (
                "atmosphere_explorer",
                "Atmosphere Explorer",
                "Use 3 different soundscapes.",
            ),
            (
                "atmosphere_collector",
                "Atmosphere Collector",
                "Use 5 different soundscapes.",
            ),
            (
                "first_companion",
                "First Companion",
            ...
            (
                "shared_initiate",
                "Shared Initiate",
                "Participate in 3 shared projects.",
            ),
            (
                "fellowship_scribe",
                "Fellowship Scribe",
                "Post 25 Chronicle messages.",
            ),
            (
                "fellowship_voice",
                "Fellowship Voice",
                "Post 50 Chronicle messages.",
            ),
            (
                "invitation_sent",
                "Invitation Sent",
                "Send your first Fellowship invitation.",
            ),
            (
                "backup_initiate",
                "Backup Initiate",
                "Save your first cloud backup.",
            ),
            (
                "sync_initiate",
                "Sync Initiate",
            ...
            (
                "conflict_survivor",
                "Conflict Survivor",
                "Resolve or record your first sync conflict.",
            ),
            ...
            (
                "ritual_first",
                "Ritual First Step",
                "Complete your first daily ritual.",
            ),
            (
                "ritual_keeper",
                "Ritual Keeper",
                "Complete 10 daily rituals.",
            ),
            (
                "ritual_master",
                "Ritual Master",
                "Complete 50 daily rituals.",
            ),
            (
                "ritual_legend",
                "Ritual Legend",
                "Complete 200 daily rituals.",
            ),
            (
                "daily_adventurer",
                "Daily Adventurer",
                "Complete 25 daily adventures.",
            ),
            (
