...
fn story(class: &str, level: i32, title: &str, content: String, sort_order: i32) -> LoreEntry {
    ...
    LoreEntry {
        ...
        unlock: LoreUnlock {
            ...
            chapter_id: None,
            display: Some(format!(
                "Complete the Level {} {} class quest.",
                level, class
            )),
        },
        rarity: None,
        ...
        (
            ...
            &[
                (
                    ...
                    "Complete 5 quests to align the compiler parameters and purge syntax anomalies.",
                    "Class Quest XP and Warlock task-reward calibration.",
                ),
                (
                    "The Log Lanterns",
                    "Complete 5 daily adventures to light the logs before they become folklore.",
                    "Permanent Warlock note rewards improve.",
                ),
                (
                    "The Broken Daemon",
                    "Complete 120 focus minutes to debug and stabilize the rogue background daemon.",
                    "Permanent Warlock focus rewards improve.",
                ),
                (
                    "The Patch Without a Ticket",
                    "Log 8 glasses of water to survive the emergency patch window.",
                    "Permanent Warlock task rewards improve.",
                ),
                (
                    "The Library of Infinite Scripts",
                    "Water The Evergrowth 3 times to grow script-bearing leaves.",
                    "Permanent Warlock project rewards improve.",
                ),
                (
                    "The Daemon of Refactoring",
                    "Write 3 journal entries to record what changed before everyone forgets.",
                    "Permanent Warlock note and journal rewards improve.",
                ),
                (
                    "The Rollback Rite",
                    "Complete 5 sidequests to clean the forgotten maintenance queue.",
                    "Permanent Warlock passive rewards improve.",
                ),
                (
                    "The Dependency Hex",
                    "Complete 3 milestones to bind the dependency graph.",
                    "Permanent Warlock milestone rewards improve.",
                ),
                (
                    "The Production Window",
                    "Complete 1 campaign before the deployment window closes.",
                    "Permanent Warlock project rewards improve.",
                ),
                (
                    "The Simulation Core",
                    "Maintain streak progress 7 times to boot the final simulation engine.",
                    "Unlocks the title Keeper of Working Systems and a permanent Warlock XP modifier.",
                ),
            ],
        ),
        (
            ...
            &[
                (
                    ...
                    "Complete 5 quests to clear the pass of procrastination monsters.",
                    "Class Quest XP and Paladin task-reward calibration.",
                ),
                (
                    "The Oath Renewed",
                    "Complete 5 daily adventures without abandoning the day's promises.",
                    "Permanent Paladin daily adventure rewards improve.",
                ),
                (
                    "The Keeper of Deadlines",
                    "Complete 120 focus minutes to reinforce the fortress deadlines.",
                    "Permanent Paladin focus rewards improve.",
                ),
                (
                    "The Hydrated Vigil",
                    "Log 8 glasses of water to hold the wall without fading.",
                    "Permanent Paladin task rewards improve.",
                ),
                (
                    "The Final Checklist",
                    "Water The Evergrowth 3 times to bless the roots of completion.",
                    "Permanent Paladin tree and task rewards improve.",
                ),
                (
                    "The Ledger of Finished Work",
                    "Write 3 journal entries proving the work actually happened.",
                    "Permanent Paladin journal rewards improve.",
                ),
                (
                    "The Shield of Discipline",
                    "Complete 5 sidequests to polish the shield against distraction.",
                    "Permanent Paladin sidequest rewards improve.",
                ),
                (
                    "The Banner of Milestones",
                    "Complete 3 milestones to plant banners on real progress.",
                    "Permanent Paladin milestone rewards improve.",
                ),
                (
                    "The Last Gate",
                    "Complete 1 campaign to prove the Order finishes the large thing too.",
                    "Permanent Paladin project rewards improve.",
                ),
                (
                    "The Citadel of Completion",
                    "Maintain streak progress 7 times to defend the Citadel.",
                    "Unlocks the title Avatar of Completion and a permanent Paladin XP modifier.",
                ),
            ],
        ),
        (
            ...
            &[
                (
                    "The Silent Archive",
                    "Complete 5 quests to index the scrolls in the quiet archive.",
                    "Class Quest XP and Sage task-reward calibration.",
                ),
                (
                    "The Note That Became Useful",
                    "Complete 5 daily adventures so knowledge leaves the shelf.",
                    "Permanent Sage daily adventure rewards improve.",
                ),
                (
                    "The Crystal of Reflection",
                    "Complete 120 focus minutes to charge the crystal of inner sight.",
                    "Permanent Sage focus rewards improve.",
                ),
                (
                    "The Clear Water Index",
                    "Log 8 glasses of water to keep the Archive's lamps bright.",
                    "Permanent Sage note rewards improve.",
                ),
                (
                    "The Hall of Thoughts",
                    "Water The Evergrowth 3 times to nourish the branches of knowledge.",
                    "Permanent Sage memory-fragment rewards improve.",
                ),
                (
                    "The Reflection Chain",
                    "Write 3 journal entries to link the day to its lesson.",
                    "Permanent Sage journal rewards improve.",
                ),
                (
                    "The Inbox Reckoning",
                    "Complete 5 sidequests to clarify what the Archive was avoiding.",
                    "Permanent Sage passive rewards improve.",
                ),
                (
                    "The Cognitive Cartography",
                    "Complete 3 milestones to map assumptions into action.",
                    "Permanent Sage milestone rewards improve.",
                ),
                (
                    "The Useful Connection",
                    "Complete 1 campaign to prove the map helped the journey.",
                    "Permanent Sage project rewards improve.",
                ),
                (
                    "The Singularity of Mind",
                    "Maintain streak progress 7 times until archive, task, and present agree.",
                    "Unlocks the title Lantern of the Silent Archive and a permanent Sage XP modifier.",
                ),
            ],
        ),
        (
            ...
            &[
                (
                    ...
                    "Complete 5 quests to lay down the base schema of construction.",
                    "Class Quest XP and Architect task-reward calibration.",
                ),
                (
                    "The Ownership Line",
                    "Complete 5 daily adventures to make responsibility visible.",
                    "Permanent Architect daily adventure rewards improve.",
                ),
                (
                    "The Pillars of Order",
                    "Complete 120 focus minutes to reinforce the support pillars.",
                    "Permanent Architect focus rewards improve.",
                ),
                (
                    "The Maintenance Reservoir",
                    "Log 8 glasses of water to cool the machinery of order.",
                    "Permanent Architect project rewards improve.",
                ),
                (
                    "The Grand Engine",
                    "Water The Evergrowth 3 times to feed the engine cooling system.",
                    "Permanent Architect tree and project rewards improve.",
                ),
                (
                    "The System Log",
                    "Write 3 journal entries to document the operating model.",
                    "Permanent Architect journal rewards improve.",
                ),
                (
                    "The Friction Audit",
                    "Complete 5 sidequests to remove drag instead of renaming it.",
                    "Permanent Architect sidequest rewards improve.",
                ),
                (
                    "The Dependency Map",
                    "Complete 3 milestones to prove the sequence works.",
                    "Permanent Architect milestone rewards improve.",
                ),
                (
                    "The Modular Framework",
                    "Complete 1 campaign to connect the system's components.",
                    "Permanent Architect project rewards improve.",
                ),
                (
                    "The Unified Schema",
                    "Maintain streak progress 7 times until the system survives repetition.",
                    "Unlocks the title Keeper of the Unified Schema and a permanent Architect XP modifier.",
                ),
            ],
        ),
        (
            ...
            &[
                (
                    ...
                    "Complete 5 quests to collect the scattered sands of time.",
                    "Class Quest XP and Chronomancer task-reward calibration.",
                ),
                (
                    "The Calendar Reckoning",
                    "Complete 5 daily adventures to spend the day where it matters.",
                    "Permanent Chronomancer daily adventure rewards improve.",
                ),
                (
                    "The Sands of Yesterday",
                    "Complete 120 focus minutes to spin the threads of memory.",
                    "Permanent Chronomancer focus rewards improve.",
                ),
                (
                    "The Clear Hour",
                    "Log 8 glasses of water to keep the timeline from blurring.",
                    "Permanent Chronomancer focus rewards improve.",
                ),
                (
                    "The Infinite Loop",
                    "Water The Evergrowth 3 times to grow temporal leaves.",
                    "Permanent Chronomancer tree rewards improve.",
                ),
                (
                    "The Time Ledger",
                    "Write 3 journal entries to record where the hours went.",
                    "Permanent Chronomancer journal rewards improve.",
                ),
                (
                    "The Meeting That Ended",
                    "Complete 5 sidequests to close loops before they multiply.",
                    "Permanent Chronomancer sidequest rewards improve.",
                ),
                (
                    "The Protected Hour",
                    "Complete 3 milestones to protect work that required sequencing.",
                    "Permanent Chronomancer milestone rewards improve.",
                ),
                (
                    "The Temporal Shield",
                    "Complete 1 campaign to defend the chosen hour from invasion.",
                    "Permanent Chronomancer project rewards improve.",
                ),
                (
                    "The Eternal Timeline",
                    "Maintain streak progress 7 times to keep continuity alive.",
                    "Unlocks the title Keeper of Reality and a permanent Chronomancer XP modifier.",
                ),
            ],
        ),
        (
            ...
            &[
                (
                    "The Ledger of Fate",
                    "Complete 5 quests to reconcile the local ledger entries.",
                    "Class Quest XP and Accountant task-reward calibration.",
                ),
                (
                    "The Receipt Hunt",
                    "Complete 5 daily adventures so today's work has a receipt.",
                    "Permanent Accountant daily adventure rewards improve.",
                ),
                (
                    "The Golden Ratio",
                    "Complete 120 focus minutes to calculate the perfect balance.",
                    "Permanent Accountant focus rewards improve.",
                ),
                (
                    "The Clear Ledger",
                    "Log 8 glasses of water because even the body has accounts payable.",
                    "Permanent Accountant all-source rewards improve.",
                ),
                (
                    "The Final Balance",
                    "Water The Evergrowth 3 times to secure the growth dividend.",
                    "Permanent Accountant tree rewards improve.",
                ),
                (
                    "The Daily Close",
                    "Write 3 journal entries to close the books on the day.",
                    "Permanent Accountant journal rewards improve.",
                ),
                (
                    "The Subscription Exorcism",
                    "Complete 5 sidequests to settle recurring obligations.",
                    "Permanent Accountant sidequest rewards improve.",
                ),
                (
                    "The Audit Trail",
                    "Complete 3 milestones to prove the numbers became reality.",
                    "Permanent Accountant milestone rewards improve.",
                ),
                (
                    "The Compound Interest Vault",
                    "Complete 1 campaign to deposit progress into the Vault.",
                    "Permanent Accountant project rewards improve.",
                ),
                (
                    "The Ledger of Eternity",
                    "Maintain streak progress 7 times to balance the infinite ledger.",
                    "Unlocks the title Keeper of the Eternal Ledger and a permanent Accountant XP modifier.",
                ),
            ],
        ),
    ];
...
fn class_story_stage(level: i32) -> &'static str {
    match level {
        10 => {
            "At the first threshold, the apprentice discovers that the Order does not ask for a grand identity. It asks for proof that one real thing can be finished without being disguised as preparation."
        }
        20 => {
            "At the second threshold, the lesson moves from effort to continuity. A single victory is useful, but repeated care is where the Realm begins to trust the hand that holds the tool."
        }
        30 => {
            "At the third threshold, focus becomes a visible discipline. The old enemy does not always roar; sometimes it merely offers one more interruption with excellent manners."
        }
        40 => {
            "At the fourth threshold, the body is admitted into the story. The Orders learned, after several embarrassing collapses, that heroic neglect is still neglect with better lighting."
        }
        50 => {
            "At the fifth threshold, the Evergrowth answers. The work is no longer only personal. Roots remember what the calendar forgets, and leaves keep quiet records of steady attention."
        }
        60 => {
            "At the sixth threshold, reflection is required. The day must be closed honestly, because unexamined progress can repeat mistakes with impressive confidence."
        }
        70 => {
            "At the seventh threshold, the abandoned edges return. Small obligations, postponed too long, begin to rule from the margins until someone gives them a proper ending."
        }
        80 => {
            "At the eighth threshold, milestones become gates instead of decorations. The apprentice learns that a marker is not a celebration of distance imagined, but evidence of ground actually crossed."
        }
        90 => {
            "At the ninth threshold, the Order asks for a larger completion. Campaigns test whether discipline can survive scale, coordination, fatigue, and the charming lie that almost finished is finished enough."
        }
        100 => {
            "At the final threshold, the class ceases to be a costume and becomes a title earned in public. The old trial ends, but its law remains in the hands, quieter and harder to lose."
        }
        _ => {
            "The threshold was old, and the lesson waited patiently for someone tired enough to need it."
        }
    }
}
...
fn merge_with_built_in_quests(mut quests: Vec<ClassQuest>) -> Vec<ClassQuest> {
    ...
    quests.retain(|q| !built_in_classes.contains(&q.class));
...
impl LoreManager {
    ...
    fn fetch_and_save() -> Result<(Vec<LoreEntry>, Vec<ClassQuest>)> {
        ...
        let quests_file: QuestsFile =
            serde_json::from_str(&quests_json).context("Invalid quests.json")?;
